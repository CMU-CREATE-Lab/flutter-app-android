...
import com.color_picker.drawable.AlphaPatternDrawable;
...
public class ColorPickerView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.colorpickerview_ColorPickerView);
        mShowAlphaPanel = a.getBoolean(R.styleable.colorpickerview_ColorPickerView_colorpickerview_alphaChannelVisible, false);
        mAlphaSliderText = a.getString(R.styleable.colorpickerview_ColorPickerView_colorpickerview_alphaChannelText);
        mSliderTrackerColor = a.getColor(R.styleable.colorpickerview_ColorPickerView_colorpickerview_sliderColor, 0xFFBDBDBD);
        mBorderColor = a.getColor(R.styleable.colorpickerview_ColorPickerView_colorpickerview_borderColor, 0xFF6E6E6E);
        a.recycle();
