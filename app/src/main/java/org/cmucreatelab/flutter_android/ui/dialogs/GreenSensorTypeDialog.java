...
public class GreenSensorTypeDialog extends SensorTypeDialog {


    public static SensorTypeDialog newInstance(int portNumber, Serializable serializable) {
        SensorTypeDialog sensorTypeDialog = new GreenSensorTypeDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        imageLight.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.sensor_green_light_l_g_68));
        imageSoilMoisture.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.sensor_green_soil_moisture_l_g_68));
        imageDistance.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.sensor_green_distance_l_g_68));
        imageSound.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.sensor_green_sound_l_g_68));
        imageAirQuality.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.sensor_green_air_quality_l_g_68));
