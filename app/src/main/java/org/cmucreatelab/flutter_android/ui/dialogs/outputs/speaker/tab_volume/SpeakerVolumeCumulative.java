 ...
 *
 * SpeakerVolumeStateHelper implementation with Cumulative relationship
 *
 */
public class SpeakerVolumeCumulative extends SpeakerVolumeStateHelper {


    SpeakerVolumeCumulative(Speaker speaker) {
        super(speaker);
    }


    public static SpeakerVolumeCumulative newInstance(Speaker speaker) {
        return new SpeakerVolumeCumulative(speaker);
    }
    ...
    public void updateView(SpeakerDialog dialog) {
        ...
        SettingsCumulative volumeSettings = (SettingsCumulative) getSpeaker().getVolume().getSettings();
    ...
    public void setAdvancedSettings(AdvancedSettings advancedSettings) {
        SettingsCumulative settingsVolume = (SettingsCumulative) getSpeaker().getVolume().getSettings();
    ...
    public void setLinkedSensor(Sensor sensor) {
        SettingsCumulative settingsCumulative = (SettingsCumulative) getSpeaker().getVolume().getSettings();
        settingsCumulative.setSensorPortNumber(sensor.getPortNumber());
    }
    ...
    public void setMaximum(int maximum) {
        SettingsCumulative settingsCumulative = (SettingsCumulative) getSpeaker().getVolume().getSettings();
        settingsCumulative.setOutputMax(maximum);
    }
