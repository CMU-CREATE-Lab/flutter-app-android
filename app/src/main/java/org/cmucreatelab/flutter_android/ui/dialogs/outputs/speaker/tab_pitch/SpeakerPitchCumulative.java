 ...
 *
 * SpeakerPitchStateHelper implementation with Cumulative relationship
 *
 */
public class SpeakerPitchCumulative extends SpeakerPitchStateHelper {


    SpeakerPitchCumulative(Speaker speaker) {
        super(speaker);
    }


    public static SpeakerPitchCumulative newInstance(Speaker speaker) {
        return new SpeakerPitchCumulative(speaker);
    }
    ...
    public void updateView(SpeakerDialog dialog) {
        ...
        SettingsCumulative pitchSettings = (SettingsCumulative) getSpeaker().getPitch().getSettings();
        // advanced settings
    ...
    public void setAdvancedSettings(AdvancedSettings advancedSettings) {
        SettingsCumulative settingsPitch = (SettingsCumulative) getSpeaker().getPitch().getSettings();
