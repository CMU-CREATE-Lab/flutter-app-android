 ...
 *
 * SpeakerPitchStateHelper implementation with Change relationship
 *
 */
public class SpeakerPitchChange extends SpeakerPitchStateHelper {


    SpeakerPitchChange(Speaker speaker) {
        super(speaker);
    }


    public static SpeakerPitchChange newInstance(Speaker speaker) {
        return new SpeakerPitchChange(speaker);
    }
    ...
    public void updateView(SpeakerDialog dialog) {
        ...
        SettingsChange pitchSettings = (SettingsChange) getSpeaker().getPitch().getSettings();
        // advanced settings
    ...
    public void setAdvancedSettings(AdvancedSettings advancedSettings) {
        SettingsChange settingsPitch = (SettingsChange) getSpeaker().getPitch().getSettings();
