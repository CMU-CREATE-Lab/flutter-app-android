 ...
 *
 * ErrorNotConnectedDialog
 *
 * A Dialog for BLEError.Type.UNKNOWN_ERROR
 */
public class ErrorNotConnectedDialog extends BaseResizableDialog {


    private static ErrorNotConnectedDialog newInstance() {
        ErrorNotConnectedDialog dialog = new ErrorNotConnectedDialog();
    ...
    public static void displayDialog(BaseNavigationActivity activity) {
        ErrorNotConnectedDialog dialog = ErrorNotConnectedDialog.newInstance();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.dialog_error_not_connected, null);
    ...
    public void onClickConnectFlutter() {
        Log.d(Constants.LOG_TAG, "ErrorNotConnectedDialog.onClickConnectFlutter");
